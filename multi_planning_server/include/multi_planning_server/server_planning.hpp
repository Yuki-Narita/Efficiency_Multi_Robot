...
search_length(0.1)
{
    ...
    path_sub1=nh1.subscribe("/robot1/move_base/VoronoiPlanner/plan", 1, &server_planning::robot1path, this);
    path_sub2=nh2.subscribe("/robot2/move_base/VoronoiPlanner/plan", 1, &server_planning::robot2path, this);
